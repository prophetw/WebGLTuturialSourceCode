...
void main() {
  ...
  // Why transfer world position instead of mvpPosition/position/mvPosition ?
  ...
  vec3 lightVec = uLight.position.xyz - position; // light to obj vec3
